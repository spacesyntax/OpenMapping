...
`nodecount2km` `nodecount10km` `nodecount100km`  | ![](img/10nodecount.png)  |  **nodecount** <br> Node Count - Node Count is a simple count of all nodes within the specified radius, nodes are essentially the points at which any street segment joins to another. This is a simple measurement that describes density.
